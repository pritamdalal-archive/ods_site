...
## **Consulting**
In 10 years of quantitative finance experience we have implemented quantitative volatility trading strategies, backtested annuity hedging programs, and built a historical options database, just to name a few.  If you have a quantitative finance analysis project, we can add valuable, field-tested expertise.  
